...
//		getContentPane().add(scrollVentana, BorderLayout.EAST);
		...
		btnOppenheimer.addActionListener((e) -> {
			...
			new VentanaPelicula(vActual, textoOp, "imagenes/PortadaOppenheimer.jpg", "OPPENHEIMER", "Oppenheimer",
					Categoria.ACCIÓN.toString(), "3h", "Cillian Murphy");
		...
		btnBarbie.addActionListener((e) -> {
			...
			new VentanaPelicula(vActual, textoBa, "imagenes/PortadaBarbie.jpg", "BARBIE", "Barbie",
					Categoria.COMEDIA.toString(), "1h 54m", "Margot Robie");
			vActual.setVisible(false);
			vActual.dispose();
		...
		btnSawX.addActionListener((e) -> {
			...
			new VentanaPelicula(vActual, textoSX, "imagenes/SawX.jpg", " SAW X", "Saw X", Categoria.TERROR.toString(),
					"1h 58m", "Tobin Bell");
			vActual.setVisible(false);
			vActual.dispose();
		...
		btnCampeonex.addActionListener((e) -> {
			...
			new VentanaPelicula(vActual, textoCa, "imagenes/Campeonex.jpg", "CAMPEONEX", "Campeonex",
					Categoria.COMEDIA.toString(), "2h 4m", "Elisa Hipólito");
			vActual.setVisible(false);
			vActual.dispose();
		...
		btnTrolls3.addActionListener((e) -> {
			...
			new VentanaPelicula(vActual, textoTr, "imagenes/PortadaTrolls3.jpg", "TROLLS3", "Trolls 3",
					Categoria.ANIMACIÓN.toString(), "1h 31m", "Justin Timberlake");
			vActual.setVisible(false);
			vActual.dispose();
